...
import static fml.plus.auth.common.mybatis.mapper.EntityColumn.DELIMITER;
...
public class Example<T> {
     ...
     */
    @SafeVarargs
    public final Example<T> selectColumns(Fn<T, ?>... fns) {
     ...
     * @return Example
     */
    public Example<T> orderBy(Fn<T, ?> fn, Order order) {
     ...
     */
    @SafeVarargs
    public final Example<T> orderByDesc(Fn<T, ?>... fns) {
        if (fns != null && fns.length > 0) {
            for (Fn<T, ?> fn : fns) {
     ...
     * @return 条件
     */
    List<Criteria<T>> getOredCriteria() {
        return oredCriteria;
    }
     ...
     * 设置 分页
     */
    public Example<T> page(int offset, int limit) {
        this.rows = new RowBounds(offset, limit);
        return this;
    }
     ...
     * @param value 值
     */
    public Example<T> set(Fn<T, ?> fn, Object value) {
     ...
     * @param value 值
     */
    public Example<T> increment(Fn<T, ?> fn, int value) {
        var column = fn.toColumn();
        this.setValues.add(new Criterion(String.format("%s = %s + %d", column, column, value)));
        return this;
    }
     ...
     * @param value 值
     */
    public Example<T> decrement(Fn<T, ?> fn, int value) {
        var column = fn.toColumn();
        this.setValues.add(new Criterion(String.format("%s = %s - %d", column, column, value)));
        return this;
    }
    ...
    protected static abstract class GeneratedCriteria<T> {
        ...
        public Criteria<T> andIsNull(Fn<T, ?> fn) {
            addCriterion(column(fn) + " IS NULL");
            return (Criteria<T>) this;
        }

        public Criteria<T> andIsNotNull(Fn<T, ?> fn) {
            addCriterion(column(fn) + " IS NOT NULL");
            return (Criteria<T>) this;
        }

        public Criteria<T> andEqualTo(Fn<T, ?> fn, Object value) {
            addCriterion(column(fn) + " =", value);
            return (Criteria<T>) this;
        }

        public Criteria<T> andNotEqualTo(Fn<T, ?> fn, Object value) {
            addCriterion(column(fn) + " <>", value);
            return (Criteria<T>) this;
        }

        public Criteria<T> andGreaterThan(Fn<T, ?> fn, Object value) {
            addCriterion(column(fn) + " >", value);
            return (Criteria<T>) this;
        }

        public Criteria<T> andGreaterThanOrEqualTo(Fn<T, ?> fn, Object value) {
            addCriterion(column(fn) + " >=", value);
            return (Criteria<T>) this;
        }

        public Criteria<T> andLessThan(Fn<T, ?> fn, Object value) {
            addCriterion(column(fn) + " <", value);
            return (Criteria<T>) this;
        }

        public Criteria<T> andLessThanOrEqualTo(Fn<T, ?> fn, Object value) {
            addCriterion(column(fn) + " <=", value);
            return (Criteria<T>) this;
        }

        public Criteria<T> andIn(Fn<T, ?> fn, Iterable<?> values) {
            addCriterion(column(fn) + " IN", values);
            return (Criteria<T>) this;
        }

        public Criteria<T> andNotIn(Fn<T, ?> fn, Iterable<?> values) {
            addCriterion(column(fn) + " NOT IN", values);
            return (Criteria<T>) this;
        }

        public Criteria<T> andBetween(Fn<T, ?> fn, Object value1, Object value2) {
            addCriterion(column(fn) + " BETWEEN", value1, value2);
            return (Criteria<T>) this;
        }

        public Criteria<T> andNotBetween(Fn<T, ?> fn, Object value1, Object value2) {
            addCriterion(column(fn) + " NOT BETWEEN", value1, value2);
            return (Criteria<T>) this;
        }

        public Criteria<T> andLike(Fn<T, ?> fn, String value) {
            addCriterion(column(fn) + "  LIKE", value);
            return (Criteria<T>) this;
        }

        public Criteria<T> andNotLike(Fn<T, ?> fn, String value) {
    ...
    public static class OrCriteria<T> extends Criteria<T> {
        ...
        @Override
        public OrCriteria<T> andIsNull(Fn<T, ?> fn) {
            super.andIsNull(fn);
            return this;
        }

        @Override
        public OrCriteria<T> andIsNotNull(Fn<T, ?> fn) {
            super.andIsNotNull(fn);
            return this;
        }

        @Override
        public OrCriteria<T> andEqualTo(Fn<T, ?> fn, Object value) {
            super.andEqualTo(fn, value);
            return this;
        }

        @Override
        public OrCriteria<T> andNotEqualTo(Fn<T, ?> fn, Object value) {
            super.andNotEqualTo(fn, value);
            return this;
        }

        @Override
        public OrCriteria<T> andGreaterThan(Fn<T, ?> fn, Object value) {
            super.andGreaterThan(fn, value);
            return this;
        }

        @Override
        public OrCriteria<T> andGreaterThanOrEqualTo(Fn<T, ?> fn, Object value) {
            super.andGreaterThanOrEqualTo(fn, value);
            return this;
        }

        @Override
        public OrCriteria<T> andLessThan(Fn<T, ?> fn, Object value) {
            super.andLessThan(fn, value);
            return this;
        }

        @Override
        public OrCriteria<T> andLessThanOrEqualTo(Fn<T, ?> fn, Object value) {
            super.andLessThanOrEqualTo(fn, value);
            return this;
        }

        @Override
        public OrCriteria<T> andIn(Fn<T, ?> fn, Iterable<?> values) {
            super.andIn(fn, values);
            return this;
        }

        @Override
        public OrCriteria<T> andNotIn(Fn<T, ?> fn, Iterable<?> values) {
            super.andNotIn(fn, values);
            return this;
        }

        @Override
        public OrCriteria<T> andBetween(Fn<T, ?> fn, Object value1, Object value2) {
            super.andBetween(fn, value1, value2);
            return this;
        }

        @Override
        public OrCriteria<T> andNotBetween(Fn<T, ?> fn, Object value1, Object value2) {
            super.andNotBetween(fn, value1, value2);
            return this;
        }

        @Override
        public OrCriteria<T> andLike(Fn<T, ?> fn, String value) {
            super.andLike(fn, value);
            return this;
        }

        @Override
        public OrCriteria<T> andNotLike(Fn<T, ?> fn, String value) {
         ...
         */
        public OrCriteria<T> isNull(boolean useCondition, Fn<T, ?> fn) {
         ...
         * @param fn 字段对应的 get 方法引用
         */
        public OrCriteria<T> isNull(Fn<T, ?> fn) {
            super.andIsNull(fn);
            return this;
        }
         ...
         * @param fn           字段对应的 get 方法引用
         */
        public OrCriteria<T> isNotNull(boolean useCondition, Fn<T, ?> fn) {
         ...
         * @param fn 字段对应的 get 方法引用
         */
        public OrCriteria<T> isNotNull(Fn<T, ?> fn) {
            super.andIsNotNull(fn);
            return this;
        }
         ...
         * @param value        值
         */
        public OrCriteria<T> eq(boolean useCondition, Fn<T, ?> fn, Object value) {
         ...
         * @param value 值
         */
        public OrCriteria<T> eq(Fn<T, ?> fn, Object value) {
            super.andEqualTo(fn, value);
            return this;
        }
         ...
         * @param value        值
         */
        public OrCriteria<T> ne(boolean useCondition, Fn<T, ?> fn, Object value) {
         ...
         * @param value 值
         */
        public OrCriteria<T> ne(Fn<T, ?> fn, Object value) {
            super.andNotEqualTo(fn, value);
            return this;
        }
         ...
         * @param value        值
         */
        public OrCriteria<T> gt(boolean useCondition, Fn<T, ?> fn, Object value) {
         ...
         * @param value 值
         */
        public OrCriteria<T> gt(Fn<T, ?> fn, Object value) {
            super.andGreaterThan(fn, value);
            return this;
        }
         ...
         * @param value        值
         */
        public OrCriteria<T> ge(boolean useCondition, Fn<T, ?> fn, Object value) {
         ...
         * @param value 值
         */
        public OrCriteria<T> ge(Fn<T, ?> fn, Object value) {
            super.andGreaterThanOrEqualTo(fn, value);
            return this;
        }
         ...
         * @param value        值
         */
        public OrCriteria<T> lt(boolean useCondition, Fn<T, ?> fn, Object value) {
         ...
         * @param value 值
         */
        public OrCriteria<T> lt(Fn<T, ?> fn, Object value) {
            super.andLessThan(fn, value);
            return this;
        }
         ...
         * @param value        值
         */
        public OrCriteria<T> le(boolean useCondition, Fn<T, ?> fn, Object value) {
         ...
         * @param value 值
         */
        public OrCriteria<T> le(Fn<T, ?> fn, Object value) {
            super.andLessThanOrEqualTo(fn, value);
            return this;
        }
         ...
         * @param values       值集合
         */
        public OrCriteria<T> in(boolean useCondition, Fn<T, ?> fn, Iterable<?> values) {
         ...
         * @param values 值集合
         */
        public OrCriteria<T> in(Fn<T, ?> fn, Iterable<?> values) {
            super.andIn(fn, values);
            return this;
        }
         ...
         * @param values       值集合
         */
        public OrCriteria<T> notIn(boolean useCondition, Fn<T, ?> fn, Iterable<?> values) {
         ...
         * @param values 值集合
         */
        public OrCriteria<T> notIn(Fn<T, ?> fn, Iterable<?> values) {
            super.andNotIn(fn, values);
            return this;
        }
         ...
         * @param value2       值2
         */
        public OrCriteria<T> between(boolean useCondition, Fn<T, ?> fn, Object value1, Object value2) {
         ...
         * @param value2 值2
         */
        public OrCriteria<T> between(Fn<T, ?> fn, Object value1, Object value2) {
            super.andBetween(fn, value1, value2);
            return this;
        }
         ...
         * @param value2       值2
         */
        public OrCriteria<T> notBetween(boolean useCondition, Fn<T, ?> fn, Object value1, Object value2) {
         ...
         * @param value2 值2
         */
        public OrCriteria<T> notBetween(Fn<T, ?> fn, Object value1, Object value2) {
            super.andNotBetween(fn, value1, value2);
            return this;
        }
         ...
         */
        public OrCriteria<T> contains(boolean useCondition, Fn<T, ?> fn, String value) {
         ...
         * @param value 值，两侧自动添加 %
         */
        public OrCriteria<T> contains(Fn<T, ?> fn, String value) {
            super.andLike(fn, "%" + value + "%");
            return this;
        }
         ...
         */
        public OrCriteria<T> startsWith(boolean useCondition, Fn<T, ?> fn, String value) {
         ...
         * @param value 值，右侧自动添加 %
         */
        public OrCriteria<T> startsWith(Fn<T, ?> fn, String value) {
            super.andLike(fn, value + "%");
            return this;
        }
         ...
         */
        public OrCriteria<T> endsWith(boolean useCondition, Fn<T, ?> fn, String value) {
         ...
         * @param value 值，左侧自动添加 %
         */
        public OrCriteria<T> endsWith(Fn<T, ?> fn, String value) {
            super.andLike(fn, "%" + value);
            return this;
        }
         ...
         */
        public OrCriteria<T> like(boolean useCondition, Fn<T, ?> fn, String value) {
         ...
         * @param value 值，需要指定 '%'(多个), '_'(单个) 模糊匹配
         */
        public OrCriteria<T> like(Fn<T, ?> fn, String value) {
            super.andLike(fn, value);
            return this;
        }
         ...
         */
        public OrCriteria<T> notLike(boolean useCondition, Fn<T, ?> fn, String value) {
         ...
         * @param value 值，需要指定 % 模糊匹配
         */
        public OrCriteria<T> notLike(Fn<T, ?> fn, String value) {
            super.andNotLike(fn, value);
            return this;
        }
